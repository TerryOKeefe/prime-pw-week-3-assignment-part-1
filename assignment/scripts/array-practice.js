...
let favoriteFoods = ['pizza', 'sushi', 'tacos', 'ramen'];
...
favoriteFoods.unshift('Cashews');
console.log('Added a food to the beginnig: ', favoriteFoods);
